...
6. JVM で検証できる変更は `./gradlew :app:ktlintCheck :app:detekt :app:testProdDebugUnitTest`、Room / DataStore / ContentResolver を跨ぐ変更は `./gradlew :app:connectedDevDebugAndroidTest` を実行する。
